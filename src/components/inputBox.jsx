...
function InputBox({
  ...
  const amountInputID = useId(); //this hook generates unique ids which make the work more optimised
  //in the first div in the return why the className is passed as a parameter?
